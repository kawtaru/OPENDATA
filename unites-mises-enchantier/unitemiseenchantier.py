...
output_base_dir = 'Unites_par_region_et_par_categorie_2016_2023_csv'
...
for excel_file in excel_files:
    ...
    # Ordre personnalisé des catégories - MISE À JOUR avec gestion des espaces
    categorie_order = {
        'Opérations à faible valeur immobilière': 1,
        'Opérations économiques et sociales': 2,
        'Opérations économiques et sociales  ': 2,  # Avec espaces supplémentaires
        'Opérations économiques et sociales   ': 2,  # Avec encore plus d'espaces
    ...
    # Tri final - ORDRE SOUHAITÉ : Région → Année → Typologie → Catégorie
...
print("✅ Fichiers CSV générés avec tri : Région → Année → Typologie → Catégorie (ordre personnalisé).")