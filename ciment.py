...
input_folder = 'Evolution_consommation_cilment_xlsx'  # Remplacez par le chemin du dossier contenant vos fichiers Excel
output_folder = 'Evolution_consommation_cilment_mod2_csv'  # Dossier où les fichiers CSV seront sauvegardés
...
for file_name in excel_files:
    ...
    # Supprimer toutes les lignes où "Régions" contient "Total national"
    df = df[~df['Régions'].str.contains("Total national", case=False, na=False)]
    ...
    # Ajouter "en milliers de tonnes" dans l'en-tête de la colonne "Consommation"
    df_long = df_long.rename(columns={"Consommation": "Consommation du ciment (en milliers de tonnes)"})
